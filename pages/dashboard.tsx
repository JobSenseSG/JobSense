...
const skillsToLearn6 = `Data Analytics and Visualization ---------------------\nIncorporating data analytics and visualization into her skill set can provide with valuable insights into user behavior and the effectiveness of her designs. Understanding tools like Google Analytics, Tableau, or Adobe Analytics can help  track key performance indicators (KPIs), measure the impact of design changes, and make data-driven decisions. This skill is crucial for optimizing digital marketing strategies and enhancing user experiences based on real-world data. Data visualization techniques will also enable to present complex information in a clear and compelling way, aiding in stakeholder communication and decision-making.`;

const skillsToLearn5 = `User Experience (UX) Design ---------------------\nAs a Graphics Designer with a strong foundation in visual design, transitioning into UX design can significantly enhance Olivia's career. UX design focuses on creating user-friendly interfaces and improving user satisfaction, which complements her current skills in product design and digital marketing. Learning UX design will enable Olivia to design with a user-centered approach, ensuring that her designs are not only visually appealing but also functional and intuitive. This skill will also allow her to conduct user research, create personas, and perform usability testing, leading to more effective and engaging products.`;

const skillsToLearn4 = ` Front-End Development (HTML, CSS, JavaScript) ---------------------\nUnderstanding front-end development can bridge the gap between design and development, making Olivia's work more seamless and integrated. By learning HTML, CSS, and JavaScript, she can bring her designs to life, creating interactive and dynamic web pages. This skill will enable her to better communicate with developers, understand technical constraints, and ensure her designs are implemented accurately. Additionally, having front-end development skills can make Olivia more versatile and valuable to her team, allowing her to take on a wider range of projects and responsibilities.`;
