...
const parseAIResponse = (responseText: string) => {
  ...
  lines.forEach((line: string) => {
    if (line.toLowerCase().includes('recommended skills')) {
      section = 'skillsRecommendation';
    } else if (line.toLowerCase().includes('weaknesses')) {
      section = 'weaknesses';
    } else if (line.toLowerCase().includes('improvement suggestions')) {
      section = 'improvementSuggestions';
    } else if (line.toLowerCase().includes('individual employee analysis')) {
      section = 'individualEmployeeAnalysis';
    } else if (line.toLowerCase().includes('overall analysis')) {
...
export default async function handler(
  ...
  try {
    ...
    Please ensure each section is clearly separated with the "------------" delimiter.`;
