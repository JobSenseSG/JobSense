        ...
        <Box bg='#121212' color='white' overflow='hidden'>
            ...
            >
                ...
                <Text fontSize={{base: 'lg', md: 'xl'}} color='gray.300' mb={8}>
                    JobSense provides personalized job recommendations,
                    real-time market insights, and certification guidance to
                    help you stay competitive in the tech industry.
                </Text>
                <HStack spacing={4}>
                    <Link href='/dashboard' passHref>
                        <Button sx={gradientBorderStyle}>
                            Go to Dashboard
                        </Button>
                    </Link>
                    <Link
                ...
                >
                    ...
                    >
                        ...
                        <Text color='gray.300' fontSize='xl'>
                            ...
                            Compare your certifications with current market
                            demands and identify areas for improvement.
                        </Text>
                        <Text color='gray.300' fontSize='xl'>
                            <span
                                style={{color: '#A020F0', fontWeight: 'bold'}}
                            ...
                            Track your job qualification scale to discover how
                            well you meet the requirements of your target jobs.
                        </Text>
                    </VStack>
